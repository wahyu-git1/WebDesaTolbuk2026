        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.potentials.update', $potential) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="5"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-desa-skyblue focus:ring focus:ring-desa-skyblue focus:ring-opacity-50"
                                required>{{ old('description', $potential->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2" id="image-preview-container">
                                @if ($potential->image)
                                    <img id="image-preview" src="{{ Storage::url($potential->image) }}"
                        ...
                        <div class="mb-4 flex items-center">
                            ...
                            <input type="checkbox" name="is_published" id="is_published" value="1"
                                ...
                                {{ old('is_published', $potential->is_published) ? 'checked' : '' }}>
