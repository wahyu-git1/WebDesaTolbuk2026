                    ...
                    <form action="{{ route('admin.products.update', $product) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="short_description" id="short_description" rows="2"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-desa-skyblue focus:ring focus:ring-desa-skyblue focus:ring-opacity-50">{{ old('short_description', $product->short_description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="8"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-desa-skyblue focus:ring focus:ring-desa-skyblue focus:ring-opacity-50">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    // Pastikan initializeTinyMCE sudah tersedia dari admin-layout
                                    if (typeof initializeTinyMCE !== 'undefined') {
                                        initializeTinyMCE('textarea#description'); // Pastikan id ini unik
                                    }
                                });
                            </script>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2" id="image-preview-container">
                                @if ($product->image)
                                    <img id="image-preview" src="{{ Storage::url($product->image) }}"
